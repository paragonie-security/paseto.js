...
function inject(rkey, cb) {
  ...
  return sodium.ready.then(() => {
    ...
    if (self.protocol() instanceof V2 || self.protocol() instanceof V4) {
 ...
 * V4
 *
 * syntactic sugar for constructor forcing use of protocol V4
 *
 * @function
 * @api public
 *
 ...
 * @api public
 */
module.exports.V4 = PrivateKeyV4;
function PrivateKeyV4() {
  PrivateKey.call(this, new V4());
}
PrivateKeyV4.prototype = Object.create(PrivateKey.prototype);
PrivateKeyV4.prototype.constructor = PrivateKeyV4;
